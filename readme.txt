# Example based on http://www.myeclipseide.com/documentation/quickstarts/jsf/

JSF 1.2 Login Demo Example using Web Page Editor

Server : Tomcat 7
Ide: Eclipse Kepler

localhost:8080/JSFLoginDemo/userLogin.faces 
